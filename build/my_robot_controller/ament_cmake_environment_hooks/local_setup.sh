...
: ${AMENT_CURRENT_PREFIX:="/home/praveen/msgandsrv/install/my_robot_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_robot_controller/environment/pythonpath.sh"
